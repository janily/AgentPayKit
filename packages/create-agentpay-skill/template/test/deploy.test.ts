...
import { assertPublishablePayee, deploySkill } from "../scripts/lib/deploy.js";
...
describe("deploySkill", () => {
  it("rejects the scaffold payee placeholder before deployment", () => {
    expect(() =>
      assertPublishablePayee("0x1111111111111111111111111111111111111111"),
    ).toThrow("PLACEHOLDER_PAY_TO");
  });
